  ...
  _createClass(StickyHeader, [{
    ...
    value: function createHeaderWaypoint() {
      var siteHeader = this.siteHeader,
          headerTriggerElement = this.headerTriggerElement;
    ...
    value: function createPageSectionWaypoints() {
      ...
      this.pageSections.each(function (index, pageSection) {
        new Waypoint({
          element: pageSection,
          handler: function handler(direction) {
            if (direction === 'down') {
...
var Modal = function () {
  ...
  _createClass(Modal, [{
    ...
    key: 'keyPressCloseModal',
    value: function keyPressCloseModal(e) {
      if (e.key === 'Escape') {
        this.modal.removeClass('modal--is-visible');
      }
    }
    ...
    value: function registerEvents() {
      ...
      var that = this;
      this.openModalButtons.each(function (index, button) {
        (0, _jquery2.default)(button).click(that.openModal.bind(that));
      });
      ...
      (0, _jquery2.default)(document).keyup(this.keyPressCloseModal.bind(this));
    }
  }]);
